<template>
  <div class="pa-3 text-left pb-5 mb-5" style="overflow-y: scroll; height: 92%">
    ...
    <div style="display: flex; align-items: center">
      ...
      <p class="my-0 ml-3">
        {{ productRate ? `${productRate} out of 5` : "Click to rate" }}
      </p>
    </div>
    ...
    <div style="display: flex; align-items: center">
      ...
      <p class="my-0 ml-3">
        {{ storeRate ? `${storeRate} out of 5` : "Click to rate" }}
      </p>
    </div>
